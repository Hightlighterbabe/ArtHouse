...
namespace ArtHouse.Pages
{
    public class ProfileModel : PageModel
    {
        ...
        public async Task OnGet()
        {
            ...
            var repo = HttpContext.RequestServices.GetService<IUserR>();
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            if(a.Id == Convert.ToInt32(HttpContext.Request.Query["id"]))
            {
                ...
                var task = HttpContext.RequestServices.GetService<IUserR>();
                HttpContext.Session.Remove("Current_user");
                await task.UpdateUserAsync(user, user_id);
                HttpContext.Session.Set("Current_user", await HttpContext.RequestServices.GetService<IUserR>().GetUserById(user_id));
